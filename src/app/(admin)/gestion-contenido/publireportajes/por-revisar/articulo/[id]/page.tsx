        ...
        <div>
            ...
            >
                ...
                <div style={{ paddingTop: '34px' }}>
                    <Btn_EditarEliminar
                        linkEditar={`/gestion-contenido/publireportajes/por-revisar/articulo/editar/${id}`}
                        id={id} // Ahora siempre es un string
                        endpointEliminar="http://localhost:3001/api/advertorials/delete"
                        redirectPath="/gestion-contenido/publireportajes/por-revisar"
                    />
                </div>
            </Box>
        </div>
